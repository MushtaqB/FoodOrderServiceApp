package com.mushtaq.poc.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("FoodOrderServiceApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("FoodOrderServiceApp");
        ...
        config.getMapConfigs().put("com.mushtaq.poc.domain.*", initializeDomainMapConfig(jHipsterProperties));
